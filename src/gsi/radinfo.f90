...
if (.not.(allocated(Evecs1))) allocate(Evecs1(nchan1,nvecs1,3),rmean1(nchan1,3),noise1(nchan1,3))
Evecs1(:,:,2)=Evecs(:,:)
rmean1(:,2)=rmean(:)
noise1(:,2)=noise(:)
deallocate(Evecs,noise,rmean)
...
if (.not.(allocated(Evecs2))) allocate(Evecs2(nchan2,nvecs2,3),rmean2(nchan2,3),noise2(nchan2,3))
Evecs2(:,:,2)=Evecs(:,:)
rmean2(:,2)=rmean(:)
noise2(:,2)=noise(:)
deallocate(Evecs,noise,rmean)
...
if (.not.(allocated(Evecs3))) allocate(Evecs3(nchan3,nvecs3,3),rmean3(nchan3,3),noise3(nchan3,3))
Evecs3(:,:,2)=Evecs(:,:)
rmean3(:,2)=rmean(:)
noise3(:,2)=noise(:)
deallocate(Evecs,noise,rmean)
